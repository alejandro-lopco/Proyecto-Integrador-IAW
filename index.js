...
function abrirDeslizable1() {
    ...
    document.getElementById("tituloOpcion1").style.transition = "800ms";
    document.getElementById("deslizableOpcion1").style.height = "600px";
    document.getElementById("deslizableOpcion1").style.transition = "800ms";
}
...
function abrirDeslizable2() {
    ...
    document.getElementById("tituloOpcion2").style.transition = "600ms";
